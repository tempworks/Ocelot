...
{
    public class TwAuthenticationMiddleware : OcelotMiddleware
    {
        ...
        public TwAuthenticationMiddleware(RequestDelegate next,
            ...
            : base(requestScopedDataRepository)
        {
            ...
            _app = app;
            _logger = loggerFactory.CreateLogger<TwAuthenticationMiddleware>();
        }
